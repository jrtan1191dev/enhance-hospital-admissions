...
function ConfigForm({
  ...
  const handleResetDefaults = () => {
    setSpecialtyWeight(40);
    setConsolidationWeight(30);
    setFallRiskWeight(15);
    setBatchThreshold(3);
  };
    ...
    <form onSubmit={handleSave} className="space-y-6">
      ...
      <div className="space-y-2 p-4 bg-slate-50 rounded-lg border border-slate-200">
        <div className="flex items-center justify-between">
          ...
          <span className="text-sm font-bold text-blue-600 bg-blue-50 px-2.5 py-1 rounded border border-blue-200">
            +{specialtyWeight} pts
          </span>
        </div>
        <input
